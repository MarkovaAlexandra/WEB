...
$works = [
[
    "name" => "Воспитатель в детском саду",
    "dateStart" => "февраль 2013",
    "dateEnd" => "настоящее время",
    "description" => "жнец, жрец, на дуде игрец",
],
[
    "name" => "Балерина",
    "dateStart" => "март 2005",
    "dateEnd" => "февраль 2013",
    "description" => "пуэте, фуетэ, жан-поль, станок, танцы до упаду в Большом, пуэте, фуетэ, жан-поль, станок, танцы до упаду в Большом",
],
[
    "name" => "Летчик",
    "dateStart" => "август 1998",
    "dateEnd" => "март 2005",
    "description" => "только смелый сам полезет в самолет",
],
];
?>
